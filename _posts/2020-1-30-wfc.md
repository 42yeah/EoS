...
Cool, eh? The thing I implement almost works, however it has a major drawback: it is __extremely slow__. Regardless, I think it's worth spending 3 day? Or how many? Looking into sources and stuffs. So let's implement it again! I will be using buttload of pseudocodes down below. And hopefully you can understand!
