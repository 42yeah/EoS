...
In which C stands for [Circle of Confusion](https://en.wikipedia.org/wiki/Circle_of_confusion), A stands for [Aperture/f-number](https://en.wikipedia.org/wiki/F-number), F stands for [Focal Length](https://en.wikipedia.org/wiki/Focal_length), and D stands for Object Distance (which we already have - this is raymarching man!). Circle of Confusion itself acts like a blur radius, and it is affected by either distance to object or aperture/camera thingy. 
