...
Now, I've implemented one in Javascript. You could play with it for a little bit, however I am not really sure whether my generator could get the same result with Maxim Gumin's or not. Also I will cap N at 2. The color stripe at the bottom is the palatte. Use it to switch colors.
...
<a id="generate" href="javascript:void(0)">generate</a> \| <a id="clear" href="javascript:void(0)">clear</a>